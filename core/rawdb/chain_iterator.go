...
func InitDatabaseFromFreezer(db siladb.Database) {
...
func iterateTransactions(db siladb.Database, from uint64, to uint64, reverse bool, interrupt chan struct{}) chan *blockTxHashes {
...
// signal received.
func indexTransactions(db siladb.Database, from uint64, to uint64, interrupt chan struct{}, hook func(uint64) bool, report bool) {
...
// There is a passed channel, the whole procedure will be interrupted if any
// signal received.
func IndexTransactions(db siladb.Database, from uint64, to uint64, interrupt chan struct{}, report bool) {
...
func indexTransactionsForTesting(db siladb.Database, from uint64, to uint64, interrupt chan struct{}, hook func(uint64) bool) {
...
// There is a passed channel, the whole procedure will be interrupted if any
// signal received.
func unindexTransactions(db siladb.Database, from uint64, to uint64, interrupt chan struct{}, hook func(uint64) bool, report bool) {
	// short circuit for invalid range
	if from >= to {
		return
	}
...
// There is a passed channel, the whole procedure will be interrupted if any
// signal received.
func UnindexTransactions(db siladb.Database, from uint64, to uint64, interrupt chan struct{}, report bool) {
...
func unindexTransactionsForTesting(db siladb.Database, from uint64, to uint64, interrupt chan struct{}, hook func(uint64) bool) {
...
func PruneTransactionIndex(db siladb.Database, pruneBlock uint64) {
