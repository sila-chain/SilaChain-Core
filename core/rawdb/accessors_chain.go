// Copyright 2018 The sila Authors
...
func ReadCanonicalHash(db siladb.Reader, number uint64) common.Hash {
	var data []byte
	db.ReadAncients(func(reader siladb.AncientReaderOp) error {
...
func WriteCanonicalHash(db siladb.KeyValueWriter, hash common.Hash, number uint64) {
...
func DeleteCanonicalHash(db siladb.KeyValueWriter, number uint64) {
...
func ReadAllHashes(db siladb.Iteratee, number uint64) []common.Hash {
...
func ReadHeaderNumber(db siladb.KeyValueReader, hash common.Hash) (uint64, bool) {
...
func WriteHeaderNumber(db siladb.KeyValueWriter, hash common.Hash, number uint64) {
...
func DeleteHeaderNumber(db siladb.KeyValueWriter, hash common.Hash) {
...
func ReadHeadHeaderHash(db siladb.KeyValueReader) common.Hash {
...
func WriteHeadHeaderHash(db siladb.KeyValueWriter, hash common.Hash) {
...
func ReadHeadBlockHash(db siladb.KeyValueReader) common.Hash {
...
func WriteHeadBlockHash(db siladb.KeyValueWriter, hash common.Hash) {
...
func ReadHeadFastBlockHash(db siladb.KeyValueReader) common.Hash {
...
func WriteHeadFastBlockHash(db siladb.KeyValueWriter, hash common.Hash) {
...
func ReadFinalizedBlockHash(db siladb.KeyValueReader) common.Hash {
...
func WriteFinalizedBlockHash(db siladb.KeyValueWriter, hash common.Hash) {
...
func ReadLastPivotNumber(db siladb.KeyValueReader) *uint64 {
...
func WriteLastPivotNumber(db siladb.KeyValueWriter, pivot uint64) {
...
func ReadTxIndexTail(db siladb.KeyValueReader) *uint64 {
...
// into database.
func WriteTxIndexTail(db siladb.KeyValueWriter, number uint64) {
...
// from database.
func DeleteTxIndexTail(db siladb.KeyValueWriter) {
...
func ReadHeaderRange(db siladb.Reader, number uint64, count uint64) []rlp.RawValue {
...
func ReadHeaderRLP(db siladb.Reader, hash common.Hash, number uint64) rlp.RawValue {
	var data []byte
	db.ReadAncients(func(reader siladb.AncientReaderOp) error {
...
func HasHeader(db siladb.Reader, hash common.Hash, number uint64) bool {
...
func ReadHeader(db siladb.Reader, hash common.Hash, number uint64) *types.Header {
...
// to-number mapping.
func WriteHeader(db siladb.KeyValueWriter, header *types.Header) {
	var (
		hash   = header.Hash()
...
func DeleteHeader(db siladb.KeyValueWriter, hash common.Hash, number uint64) {
...
func deleteHeaderWithoutNumber(db siladb.KeyValueWriter, hash common.Hash, number uint64) {
...
func isCanon(reader siladb.AncientReaderOp, number uint64, hash common.Hash) bool {
...
func ReadBodyRLP(db siladb.Reader, hash common.Hash, number uint64) rlp.RawValue {
	// First try to look up the data in ancient database. Extra hash
	// comparison is necessary since ancient database only maintains
	// the canonical data.
	var data []byte
...
func ReadCanonicalBodyRLP(db siladb.Reader, number uint64, hash *common.Hash) rlp.RawValue {
	var data []byte
	db.ReadAncients(func(reader siladb.AncientReaderOp) error {
		data, _ = reader.Ancient(ChainFreezerBodiesTable, number)
		if len(data) > 0 {
...
func WriteBodyRLP(db siladb.KeyValueWriter, hash common.Hash, number uint64, rlp rlp.RawValue) {
...
func HasBody(db siladb.Reader, hash common.Hash, number uint64) bool {
	if isCanon(db, number, hash) {
		return true
	}
...
func ReadBody(db siladb.Reader, hash common.Hash, number uint64) *types.Body {
...
func WriteBody(db siladb.KeyValueWriter, hash common.Hash, number uint64, body *types.Body) {
...
func DeleteBody(db siladb.KeyValueWriter, hash common.Hash, number uint64) {
...
// to a block.
func HasReceipts(db siladb.Reader, hash common.Hash, number uint64) bool {
	if isCanon(db, number, hash) {
		return true
	}
...
func ReadReceiptsRLP(db siladb.Reader, hash common.Hash, number uint64) rlp.RawValue {
	var data []byte
	db.ReadAncients(func(reader siladb.AncientReaderOp) error {
		// Check if the data is in ancients
		if isCanon(reader, number, hash) {
...
func ReadCanonicalReceiptsRLP(db siladb.Reader, number uint64, hash *common.Hash) rlp.RawValue {
	var data []byte
	db.ReadAncients(func(reader siladb.AncientReaderOp) error {
		data, _ = reader.Ancient(ChainFreezerReceiptTable, number)
		if len(data) > 0 {
...
func ReadRawReceipts(db siladb.Reader, hash common.Hash, number uint64) types.Receipts {
...
func ReadReceipts(db siladb.Reader, hash common.Hash, number uint64, time uint64, config *params.ChainConfig) types.Receipts {
...
func WriteReceipts(db siladb.KeyValueWriter, hash common.Hash, number uint64, receipts types.Receipts) {
...
func WriteRawReceipts(db siladb.KeyValueWriter, hash common.Hash, number uint64, receipts rlp.RawValue) {
	// Store the flattened receipt slice
...
func DeleteReceipts(db siladb.KeyValueWriter, hash common.Hash, number uint64) {
...
func HasAccessList(db siladb.Reader, hash common.Hash, number uint64) bool {
	has, _ := db.Has(accessListKey(number, hash))
	return has
}

// ReadAccessListRLP retrieves the RLP-encoded block access list for a block.
func ReadAccessListRLP(db siladb.Reader, hash common.Hash, number uint64) rlp.RawValue {
	var data []byte
	db.ReadAncients(func(reader siladb.AncientReaderOp) error {
...
func ReadAccessList(db siladb.Reader, hash common.Hash, number uint64) *bal.BlockAccessList {
...
func WriteAccessList(db siladb.KeyValueWriter, hash common.Hash, number uint64, b *bal.BlockAccessList) {
...
func WriteAccessListRLP(db siladb.KeyValueWriter, hash common.Hash, number uint64, encoded rlp.RawValue) {
...
func DeleteAccessList(db siladb.KeyValueWriter, hash common.Hash, number uint64) {
...
func ReadLogs(db siladb.Reader, hash common.Hash, number uint64) [][]*types.Log {
	// Retrieve the flattened receipt slice
	data := ReadReceiptsRLP(db, hash, number)
	if len(data) == 0 {
		return nil
...
func ReadBlock(db siladb.Reader, hash common.Hash, number uint64) *types.Block {
	header := ReadHeader(db, hash, number)
	if header == nil {
		return nil
	}
...
func WriteBlock(db siladb.KeyValueWriter, block *types.Block) {
...
func WriteAncientBlocks(db siladb.AncientWriter, blocks []*types.Block, receipts []rlp.RawValue) (int64, error) {
	return db.ModifyAncients(func(op siladb.AncientWriteOp) error {
...
func writeAncientBlock(op siladb.AncientWriteOp, block *types.Block, header *types.Header, receipts rlp.RawValue) error {
	num := block.NumberU64()
...
func WriteAncientHeaderChain(db siladb.AncientWriter, headers []*types.Header) (int64, error) {
	return db.ModifyAncients(func(op siladb.AncientWriteOp) error {
...
func DeleteBlock(db siladb.KeyValueWriter, hash common.Hash, number uint64) {
...
// the hash to number mapping.
func DeleteBlockWithoutNumber(db siladb.KeyValueWriter, hash common.Hash, number uint64) {
	DeleteReceipts(db, hash, number)
	deleteHeaderWithoutNumber(db, hash, number)
	DeleteBody(db, hash, number)
	DeleteAccessList(db, hash, number)
...
func ReadBadBlock(db siladb.Reader, hash common.Hash) *types.Block {
...
func ReadAllBadBlocks(db siladb.Reader) []*types.Block {
	blob, err := db.Get(badBlockKey)
	if err != nil {
		return nil
	}
...
func WriteBadBlock(db siladb.KeyValueStore, block *types.Block) {
	blob, err := db.Get(badBlockKey)
	if err != nil {
...
func ReadHeadHeader(db siladb.Reader) *types.Header {
...
func ReadHeadBlock(db siladb.Reader) *types.Block {
