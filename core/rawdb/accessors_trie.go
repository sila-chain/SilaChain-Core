...
func ReadAccountTrieNode(db siladb.KeyValueReader, path []byte) []byte {
...
func HasAccountTrieNode(db siladb.KeyValueReader, path []byte) bool {
...
func WriteAccountTrieNode(db siladb.KeyValueWriter, path []byte, node []byte) {
...
func DeleteAccountTrieNode(db siladb.KeyValueWriter, path []byte) {
...
func ReadStorageTrieNode(db siladb.KeyValueReader, accountHash common.Hash, path []byte) []byte {
...
func HasStorageTrieNode(db siladb.KeyValueReader, accountHash common.Hash, path []byte) bool {
...
func WriteStorageTrieNode(db siladb.KeyValueWriter, accountHash common.Hash, path []byte, node []byte) {
...
func DeleteStorageTrieNode(db siladb.KeyValueWriter, accountHash common.Hash, path []byte) {
...
func ReadLegacyTrieNode(db siladb.KeyValueReader, hash common.Hash) []byte {
...
func HasLegacyTrieNode(db siladb.KeyValueReader, hash common.Hash) bool {
	ok, _ := db.Has(hash.Bytes())
	return ok
}

// WriteLegacyTrieNode writes the provided legacy trie node to database.
func WriteLegacyTrieNode(db siladb.KeyValueWriter, hash common.Hash, node []byte) {
...
func DeleteLegacyTrieNode(db siladb.KeyValueWriter, hash common.Hash) {
...
func HasTrieNode(db siladb.KeyValueReader, owner common.Hash, path []byte, hash common.Hash, scheme string) bool {
	switch scheme {
	case HashScheme:
...
func ReadTrieNode(db siladb.KeyValueReader, owner common.Hash, path []byte, hash common.Hash, scheme string) []byte {
	switch scheme {
	case HashScheme:
...
func WriteTrieNode(db siladb.KeyValueWriter, owner common.Hash, path []byte, hash common.Hash, node []byte, scheme string) {
	switch scheme {
	case HashScheme:
...
// hash-scheme requires the node hash as the identifier.
// path-scheme requires the node owner and path as the identifier.
func DeleteTrieNode(db siladb.KeyValueWriter, owner common.Hash, path []byte, hash common.Hash, scheme string) {
	switch scheme {
	case HashScheme:
...
func ReadStateScheme(db siladb.Database) string {
...
//     compatible with persistent state scheme.
func ParseStateScheme(provided string, disk siladb.Database) (string, error) {
