...
func ReadStateHistoryIndexMetadata(db siladb.KeyValueReader) []byte {
...
// into database.
func WriteStateHistoryIndexMetadata(db siladb.KeyValueWriter, blob []byte) {
...
func DeleteStateHistoryIndexMetadata(db siladb.KeyValueWriter) {
...
func ReadTrienodeHistoryIndexMetadata(db siladb.KeyValueReader) []byte {
...
// into database.
func WriteTrienodeHistoryIndexMetadata(db siladb.KeyValueWriter, blob []byte) {
...
func DeleteTrienodeHistoryIndexMetadata(db siladb.KeyValueWriter) {
...
// account address.
func ReadAccountHistoryIndex(db siladb.KeyValueReader, addressHash common.Hash) []byte {
...
func WriteAccountHistoryIndex(db siladb.KeyValueWriter, addressHash common.Hash, data []byte) {
...
// the database.
func DeleteAccountHistoryIndex(db siladb.KeyValueWriter, addressHash common.Hash) {
...
func ReadStorageHistoryIndex(db siladb.KeyValueReader, addressHash common.Hash, storageHash common.Hash) []byte {
...
func WriteStorageHistoryIndex(db siladb.KeyValueWriter, addressHash common.Hash, storageHash common.Hash, data []byte) {
...
func DeleteStorageHistoryIndex(db siladb.KeyValueWriter, addressHash common.Hash, storageHash common.Hash) {
...
// account address and storage key hash.
func ReadTrienodeHistoryIndex(db siladb.KeyValueReader, addressHash common.Hash, path []byte) []byte {
...
func WriteTrienodeHistoryIndex(db siladb.KeyValueWriter, addressHash common.Hash, path []byte, data []byte) {
...
func DeleteTrienodeHistoryIndex(db siladb.KeyValueWriter, addressHash common.Hash, path []byte) {
...
func ReadAccountHistoryIndexBlock(db siladb.KeyValueReader, addressHash common.Hash, blockID uint32) []byte {
...
func WriteAccountHistoryIndexBlock(db siladb.KeyValueWriter, addressHash common.Hash, blockID uint32, data []byte) {
...
func DeleteAccountHistoryIndexBlock(db siladb.KeyValueWriter, addressHash common.Hash, blockID uint32) {
...
func ReadStorageHistoryIndexBlock(db siladb.KeyValueReader, addressHash common.Hash, storageHash common.Hash, blockID uint32) []byte {
...
func WriteStorageHistoryIndexBlock(db siladb.KeyValueWriter, addressHash common.Hash, storageHash common.Hash, id uint32, data []byte) {
...
func DeleteStorageHistoryIndexBlock(db siladb.KeyValueWriter, addressHash common.Hash, storageHash common.Hash, id uint32) {
...
// identifier along with the block id.
func ReadTrienodeHistoryIndexBlock(db siladb.KeyValueReader, addressHash common.Hash, path []byte, blockID uint32) []byte {
...
func WriteTrienodeHistoryIndexBlock(db siladb.KeyValueWriter, addressHash common.Hash, path []byte, id uint32, data []byte) {
...
func DeleteTrienodeHistoryIndexBlock(db siladb.KeyValueWriter, addressHash common.Hash, path []byte, id uint32) {
...
func DeleteStateHistoryIndexes(db siladb.KeyValueRangeDeleter) {
...
func DeleteTrienodeHistoryIndexes(db siladb.KeyValueRangeDeleter) {
...
func DeleteHistoryByRange(db siladb.KeyValueRangeDeleter, prefix []byte) {
	start := prefix
	...
	for {
		...
		if errors.Is(err, siladb.ErrTooManyKeys) {
			continue
		}
