...
func DecodeTxLookupEntry(data []byte, db siladb.Reader) *uint64 {
...
func ReadTxLookupEntry(db siladb.Reader, hash common.Hash) *uint64 {
...
func writeTxLookupEntry(db siladb.KeyValueWriter, hash common.Hash, numberBytes []byte) {
...
// a list of hashes
func WriteTxLookupEntries(db siladb.KeyValueWriter, number uint64, hashes []common.Hash) {
...
func WriteTxLookupEntriesByBlock(db siladb.KeyValueWriter, block *types.Block) {
...
func DeleteTxLookupEntry(db siladb.KeyValueWriter, hash common.Hash) {
...
func DeleteTxLookupEntries(db siladb.KeyValueWriter, hashes []common.Hash) {
	for _, hash := range hashes {
...
func DeleteAllTxLookupEntries(db siladb.KeyValueStore, condition func(common.Hash, []byte) bool) {
	...
	for iter.Next() {
		...
		if batch.ValueSize() >= siladb.IdealBatchSize {
...
// chain is visible.
func ReadCanonicalTransaction(db siladb.Reader, hash common.Hash) (*types.Transaction, common.Hash, uint64, uint64) {
...
// chain is visible.
func ReadCanonicalReceipt(db siladb.Reader, hash common.Hash, config *params.ChainConfig) (*types.Receipt, common.Hash, uint64, uint64) {
...
func ReadCanonicalRawReceipt(db siladb.Reader, blockHash common.Hash, blockNumber, txIndex uint64) (*types.Receipt, RawReceiptContext, error) {
...
func ReadFilterMapBaseRows(db siladb.KeyValueReader, mapRowIndex uint64, rowCount uint32, bitLength uint) ([][]uint32, error) {
	byteLength := int(bitLength) / 8
	if int(bitLength) != byteLength*8 {
		panic("invalid bit length")
	}
...
func WriteFilterMapExtRow(db siladb.KeyValueWriter, mapRowIndex uint64, row []uint32, bitLength uint) {
	byteLength := int(bitLength) / 8
	if int(bitLength) != byteLength*8 {
		panic("invalid bit length")
	}
...
func WriteFilterMapBaseRows(db siladb.KeyValueWriter, mapRowIndex uint64, rows [][]uint32, bitLength uint) {
	byteLength := int(bitLength) / 8
	if int(bitLength) != byteLength*8 {
		panic("invalid bit length")
	}
...
func DeleteFilterMapRows(db siladb.KeyValueStore, mapRows common.Range[uint64], hashScheme bool, stopCallback func(bool) bool) error {
...
func ReadFilterMapLastBlock(db siladb.KeyValueReader, mapIndex uint32) (uint64, common.Hash, error) {
...
// last log value entry of the given map.
func WriteFilterMapLastBlock(db siladb.KeyValueWriter, mapIndex uint32, blockNumber uint64, id common.Hash) {
	var enc [40]byte
...
// last log value entry of the given map.
func DeleteFilterMapLastBlock(db siladb.KeyValueWriter, mapIndex uint32) {
	if err := db.Delete(filterMapLastBlockKey(mapIndex)); err != nil {
		log.Crit("Failed to delete filter map last block pointer", "err", err)
	}
}

func DeleteFilterMapLastBlocks(db siladb.KeyValueStore, maps common.Range[uint32], hashScheme bool, stopCallback func(bool) bool) error {
...
func ReadBlockLvPointer(db siladb.KeyValueReader, blockNumber uint64) (uint64, error) {
...
// generated by the given block are located.
func WriteBlockLvPointer(db siladb.KeyValueWriter, blockNumber, lvPointer uint64) {
	var encPtr [8]byte
...
// generated by the given block are located.
func DeleteBlockLvPointer(db siladb.KeyValueWriter, blockNumber uint64) {
	if err := db.Delete(filterMapBlockLVKey(blockNumber)); err != nil {
		log.Crit("Failed to delete block log value pointer", "err", err)
	}
}

func DeleteBlockLvPointers(db siladb.KeyValueStore, blocks common.Range[uint64], hashScheme bool, stopCallback func(bool) bool) error {
...
func ReadFilterMapsRange(db siladb.KeyValueReader) (FilterMapsRange, bool, error) {
...
func WriteFilterMapsRange(db siladb.KeyValueWriter, fmRange FilterMapsRange) {
...
func DeleteFilterMapsRange(db siladb.KeyValueWriter) {
...
func deletePrefixRange(db siladb.KeyValueStore, prefix []byte, hashScheme bool, stopCallback func(bool) bool) error {
...
func DeleteFilterMapsDb(db siladb.KeyValueStore, hashScheme bool, stopCallback func(bool) bool) error {
...
func DeleteBloomBitsDb(db siladb.KeyValueStore, hashScheme bool, stopCallback func(bool) bool) error {
