// Copyright 2019 The sila Authors
...
func ReadSnapshotDisabled(db siladb.KeyValueReader) bool {
	disabled, _ := db.Has(snapshotDisabledKey)
	return disabled
}

// WriteSnapshotDisabled stores the snapshot pause flag.
func WriteSnapshotDisabled(db siladb.KeyValueWriter) {
...
func DeleteSnapshotDisabled(db siladb.KeyValueWriter) {
...
func ReadSnapshotRoot(db siladb.KeyValueReader) common.Hash {
...
// the persisted snapshot.
func WriteSnapshotRoot(db siladb.KeyValueWriter, root common.Hash) {
...
// invalid.
func DeleteSnapshotRoot(db siladb.KeyValueWriter) {
...
func ReadAccountSnapshot(db siladb.KeyValueReader, hash common.Hash) []byte {
	data, _ := db.Get(accountSnapshotKey(hash))
	return data
}

// WriteAccountSnapshot stores the snapshot entry of an account trie leaf.
func WriteAccountSnapshot(db siladb.KeyValueWriter, hash common.Hash, entry []byte) {
...
func DeleteAccountSnapshot(db siladb.KeyValueWriter, hash common.Hash) {
...
func ReadStorageSnapshot(db siladb.KeyValueReader, accountHash, storageHash common.Hash) []byte {
	data, _ := db.Get(storageSnapshotKey(accountHash, storageHash))
	return data
}

// WriteStorageSnapshot stores the snapshot entry of a storage trie leaf.
func WriteStorageSnapshot(db siladb.KeyValueWriter, accountHash, storageHash common.Hash, entry []byte) {
...
func DeleteStorageSnapshot(db siladb.KeyValueWriter, accountHash, storageHash common.Hash) {
...
func IterateStorageSnapshots(db siladb.Iteratee, accountHash common.Hash) siladb.Iterator {
...
func ReadSnapshotJournal(db siladb.KeyValueReader) []byte {
...
func WriteSnapshotJournal(db siladb.KeyValueWriter, journal []byte) {
...
// the last shutdown
func DeleteSnapshotJournal(db siladb.KeyValueWriter) {
...
// the last shutdown.
func ReadSnapshotGenerator(db siladb.KeyValueReader) []byte {
...
// shutdown.
func WriteSnapshotGenerator(db siladb.KeyValueWriter, generator []byte) {
...
// the last shutdown
func DeleteSnapshotGenerator(db siladb.KeyValueWriter) {
...
// snapshot layer.
func ReadSnapshotRecoveryNumber(db siladb.KeyValueReader) *uint64 {
...
// snapshot layer.
func WriteSnapshotRecoveryNumber(db siladb.KeyValueWriter, number uint64) {
	var buf [8]byte
...
// snapshot layer.
func DeleteSnapshotRecoveryNumber(db siladb.KeyValueWriter) {
...
func ReadSnapshotSyncStatus(db siladb.KeyValueReader) []byte {
	data, _ := db.Get(snapshotSyncStatusKey)
	return data
}

// WriteSnapshotSyncStatus stores the serialized sync status to save at shutdown.
func WriteSnapshotSyncStatus(db siladb.KeyValueWriter, status []byte) {
...
func DeleteSnapshotSyncStatus(db siladb.KeyValueWriter) {
