...
func (f *chainFreezer) readHeadNumber(db siladb.KeyValueReader) uint64 {
...
func (f *chainFreezer) readFinalizedNumber(db siladb.KeyValueReader) uint64 {
...
func (f *chainFreezer) freezeThreshold(db siladb.KeyValueReader) (uint64, error) {
	var (
...
func (f *chainFreezer) freeze(db siladb.KeyValueStore) {
	var (
		backoff   bool
...
func (f *chainFreezer) freezeRange(nfdb *nofreezedb, number, limit uint64) (hashes []common.Hash, err error) {
	...
	_, err = f.ModifyAncients(func(op siladb.AncientWriteOp) error {
...
func (f *chainFreezer) ReadAncients(fn func(siladb.AncientReaderOp) error) (err error) {
...
func (f *chainFreezer) ModifyAncients(fn func(siladb.AncientWriteOp) error) (int64, error) {
