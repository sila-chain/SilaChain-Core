...
// PrecompiledContractsHomestead contains the default set of pre-compiled Sila
...
// PrecompiledContractsByzantium contains the default set of pre-compiled Sila
...
// PrecompiledContractsIstanbul contains the default set of pre-compiled Sila
...
// PrecompiledContractsBerlin contains the default set of pre-compiled Sila
...
// PrecompiledContractsCancun contains the default set of pre-compiled Sila
...
// PrecompiledContractsPrague contains the set of pre-compiled Sila
...
// PrecompiledContractsOsaka contains the set of pre-compiled Sila
