...
func ReadGenesis(db siladb.Database) (*Genesis, error) {
	var genesis Genesis
...
func getGenesisState(db siladb.Database, blockhash common.Hash) (alloc types.GenesisAlloc, err error) {
...
func SetupGenesisBlock(db siladb.Database, triedb *triedb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, *params.ConfigCompatError, error) {
	return SetupGenesisBlockWithOverride(db, triedb, genesis, nil, nil)
}

func SetupGenesisBlockWithOverride(db siladb.Database, triedb *triedb.Database, genesis *Genesis, overrides *ChainOverrides, tracer *tracing.Hooks) (*params.ChainConfig, common.Hash, *params.ConfigCompatError, error) {
...
func LoadChainConfig(db siladb.Database, genesis *Genesis) (cfg *params.ChainConfig, ghash common.Hash, err error) {
...
func (g *Genesis) toBlockWithRoot(root common.Hash) *types.Block {
	...
	if g.Difficulty == nil {
		if g.Config != nil && g.Config.Silaash == nil {
...
func (g *Genesis) Commit(db siladb.Database, triedb *triedb.Database, tracer *tracing.Hooks) (*types.Block, error) {
	if g.Number != 0 {
...
// The block is committed as the canonical head block.
func (g *Genesis) MustCommit(db siladb.Database, triedb *triedb.Database) *types.Block {
...
func EnableUBTAtGenesis(db siladb.Database, genesis *Genesis) (bool, error) {
	if genesis != nil {
		if genesis.Config == nil {
