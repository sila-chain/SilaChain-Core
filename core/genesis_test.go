...
func testSetupGenesis(t *testing.T, scheme string) {
	var (
		...
		customg     = Genesis{
			Config: &params.ChainConfig{HomesteadBlock: big.NewInt(3), Ethash: &params.SilaPoWConfig{}},
	...
	oldcustomg.Config = &params.ChainConfig{HomesteadBlock: big.NewInt(2), Ethash: &params.SilaPoWConfig{}}
