...
func NewPruner(db siladb.Database, config Config) (*Pruner, error) {
...
func prune(snaptree *snapshot.Tree, root common.Hash, maindb siladb.Database, stateBloom *stateBloom, bloomPath string, middleStateRoots map[common.Hash]struct{}, start time.Time) error {
...
// in the disk.
func RecoverPruning(datadir string, db siladb.Database) error {
...
func extractGenesis(db siladb.Database, stateBloom *stateBloom) error {
