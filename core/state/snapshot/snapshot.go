...
//     a background thread.
func New(config Config, diskdb siladb.KeyValueStore, triedb *triedb.Database, root common.Hash) (*Tree, error) {
...
func (t *Tree) Verify(root common.Hash) error {
	...
	got, err := generateTrieRoot(nil, "", acctIt, common.Hash{}, stackTrieGenerate, func(db siladb.KeyValueWriter, accountHash, codeHash common.Hash, stat *generateStats) (common.Hash, error) {
