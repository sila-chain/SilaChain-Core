...
func loadAndParseJournal(db siladb.KeyValueStore, base *diskLayer) (snapshot, journalGenerator, error) {
...
func loadSnapshot(diskdb siladb.KeyValueStore, triedb *triedb.Database, root common.Hash, cache int, recovery bool, noBuild bool) (snapshot, bool, error) {
...
func iterateJournal(db siladb.KeyValueReader, callback journalCallback) error {
