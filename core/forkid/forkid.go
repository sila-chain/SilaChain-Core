...
// timestampThreshold is the SilaChain mainnet genesis timestamp. It is used to
...
// NewID calculates the SilaChain fork ID from the chain config, genesis hash, head and time.
...
// NewIDWithChain calculates the SilaChain fork ID from an existing chain instance.
