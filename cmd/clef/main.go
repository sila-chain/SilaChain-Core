...
var (
	...
	chainIdFlag = &cli.Int64Flag{
		Name:  "chainid",
		Value: params.SilaMainnetChainConfig.ChainID.Int64(),
		Usage: "Chain id to use for signing (2026=sila-mainnet, 1=mainnet, 17000=Holesky)",
	}
...
func GenDoc(ctx *cli.Context) error {
	...
	{ // WHen a signed tx is ready to go out
		...
		add("OnApproved - SignTransactionResult", desc, &silaapi.SignTransactionResult{Raw: rlpdata, Tx: &tx})
	}
	{ // User input
