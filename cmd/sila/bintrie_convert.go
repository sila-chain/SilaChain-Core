...
func runConversionLoop(chaindb siladb.Database, srcTriedb *triedb.Database, destTriedb *triedb.Database, binTrie *bintrie.BinaryTrie, root common.Hash, memLimit uint64) (common.Hash, error) {
...
func deleteMPTData(chaindb siladb.Database, srcTriedb *triedb.Database, root common.Hash) error {
