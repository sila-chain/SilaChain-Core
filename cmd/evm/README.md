...
- `--state.reward`
  - For silaash, it is `5000000000000000000` `wei`,
...
```
    ...
    --seal.silaash               Seal block with silaash. (default: false)
    --seal.silaash.dir value     Path to silaash DAG. If none exists, a new DAG will be generated.
    --seal.silaash.mode value    Defines the type and amount of PoW verification an silaash silaEngine makes. (default: "normal")
...
doubt, the [`execution-apis`](https://github.com/sila-org/execution-apis) way
