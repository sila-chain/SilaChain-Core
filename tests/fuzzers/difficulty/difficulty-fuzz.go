...
func (f *fuzzer) fuzz() int {
	...
	for i, pair := range []struct {
		...
		{silaash.FrontierDifficultyCalculator, silaash.CalcDifficultyFrontierU256},
		{silaash.HomesteadDifficultyCalculator, silaash.CalcDifficultyHomesteadU256},
		{silaash.DynamicDifficultyCalculator(bombDelay), silaash.MakeDifficultyCalculatorU256(bombDelay)},
	} {
