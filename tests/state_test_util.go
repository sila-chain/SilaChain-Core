...
func (tx *stTransaction) toMessage(ps stPostState, baseFee *big.Int) (*core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/sila-org/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
...
func MakePreState(db siladb.Database, accounts types.GenesisAlloc, snapshotter bool, scheme string) StateTestState {
