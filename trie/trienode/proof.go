...
func (db *ProofSet) Store(target siladb.KeyValueWriter) {
	db.lock.RLock()
	defer db.lock.RUnlock()
...
// ProofList stores an ordered list of trie nodes. It implements siladb.KeyValueWriter.
type ProofList []rlp.RawValue

// Store writes the contents of the list to the given database
func (n ProofList) Store(db siladb.KeyValueWriter) {
	for _, node := range n {
