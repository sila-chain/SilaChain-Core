...
func NewSync(root common.Hash, database siladb.KeyValueReader, callback LeafCallback, scheme string) *Sync {
	ts := &Sync{
		scheme:   scheme,
		database: database,
...
// both sila/6x style fast sync and snap/1x style state sync, the paths of trie
...
func (s *Sync) Commit(dbw siladb.Batch) error {
