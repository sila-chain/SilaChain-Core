...
import (
	...
	"github.com/sila-org/sila/silaclient/simulated"
)
...
func testSetup() (*backends.SimulatedBackend, error) {
	backend := simulated.NewBackend(
		...
		func(nodeConf *node.Config, silaConf *silaconfig.Config) {
			silaConf.Genesis.Difficulty = big.NewInt(0)
		},
	)
...
func TestErrors(t *testing.T) {
	...
	raw, hasRevertErrorData := silaclient.RevertErrorData(err)
