...
// the `coin_type` 60' (or 0x8000003C) used by legacy Ethereum-compatible wallets.
//
// The legacy-compatible root path is m/44'/60'/0'/0 according to the specification
