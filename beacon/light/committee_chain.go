...
func NewCommitteeChain(db siladb.KeyValueStore, config *params.ChainConfig, signerThreshold int, enforceTime bool) *CommitteeChain {
...
func NewTestCommitteeChain(db siladb.KeyValueStore, config *params.ChainConfig, signerThreshold int, enforceTime bool, clock *mclock.Simulated) *CommitteeChain {
...
func newCommitteeChain(db siladb.KeyValueStore, config *params.ChainConfig, signerThreshold int, enforceTime bool, sigVerifier committeeSigVerifier, clock mclock.Clock, unixNano func() int64) *CommitteeChain {
	s := &CommitteeChain{
...
func (s *CommitteeChain) deleteCommitteesFrom(batch siladb.Batch, period uint64) {
