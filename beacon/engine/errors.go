...
// EngineAPIError is a Sila Engine API standardized error message between consensus and execution
// clients, also containing any custom error message the execution client might include.
...
var (
	// VALID is returned by the Sila Engine API in the following calls:
	...
	// INVALID is returned by the Sila Engine API in the following calls:
	...
	// SYNCING is returned by the Sila Engine API in the following calls:
	...
	// ACCEPTED is returned by the Sila Engine API in the following calls:
