...
func doCheckBadDeps() {
	baddeps := [][2]string{
		...
		{"github.com/sila-org/sila/core/rawdb", "github.com/sila-org/sila/siladb/leveldb"},
		{"github.com/sila-org/sila/core/rawdb", "github.com/sila-org/sila/siladb/pebbledb"},
	}
	tc := new(build.GoToolchain)
	...
	*workdir = makeWorkdir(*workdir)
	...
	for _, pkg := range debPackages {
		for _, distro := range debDistros {
			// Prepare the debian package with the sila sources.
...
type debMetadata struct {
	...
	// sila version being built. Note that this
