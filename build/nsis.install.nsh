...
!define HELPURL "https://github.com/sila-org/sila/issues"
!define UPDATEURL "https://github.com/sila-org/sila/releases"
!define ABOUTURL "https://github.com/sila-org/sila#silachain"
...
Section "Sila" GETH_IDX
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "Sila incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\sila.exe" "" "" "SilaChain" 30303 "" "" ""
  SimpleFC::AdvAddRule "Sila outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\sila.exe" "" "" "SilaChain" "" 30303 "" ""
  SimpleFC::AdvAddRule "Sila UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\sila.exe" "" "" "SilaChain" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\sila.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\sila.ipc"
