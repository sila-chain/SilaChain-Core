...
// mapped from textual names used in the tests below to actual SilaChain private
...
// address retrieves the SilaChain address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the SilaChain address
