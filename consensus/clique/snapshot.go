...
type Snapshot struct {
	config   *params.CliqueConfig // Consensus silaEngine parameters to fine tune behavior
...
func loadSnapshot(config *params.CliqueConfig, sigcache *sigLRU, db siladb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db siladb.Database) error {
