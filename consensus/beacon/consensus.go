...
// stock Sila consensus silaEngine.
func (beacon *Beacon) VerifyHeader(chain consensus.ChainHeaderReader, header *types.Header) error {
	// During the live merge transition, the consensus silaEngine used the terminal
...
// verifyHeader checks whether a header conforms to the consensus rules of the
// stock Sila consensus silaEngine. The difference between the beacon and classic is
