...
import (
	...
	jsassets "github.com/sila-org/sila/sila/tracers/js/internal/tracers"
)

var assetTracers = make(map[string]string)

// init retrieves the JavaScript transaction tracers included in sila.
func init() {
	var err error
...
// JS functions on the relevant EVM hooks. It uses Goja as its JS silaEngine.
