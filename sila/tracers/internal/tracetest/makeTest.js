...
var makeTest = function(tx, traceConfig) {
    ...
    var block   = sila.getBlock(sila.getTransaction(tx).blockHash);
    var genesis = sila.getBlock(block.parentHash);
    ...
    genesis.config = admin.nodeInfo.protocols.sila.config;
    ...
    var data = {
        genesis: genesis,
        context: context,
        input:   sila.getRawTransaction(tx),
        result:  result,
    };
