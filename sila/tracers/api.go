...
func (api *API) chainContext(ctx context.Context) core.ChainContext {
	return silaapi.NewChainContext(ctx, api.backend)
}
...
func (api *API) TraceTransaction(ctx context.Context, hash common.Hash, config *TraceConfig) (interface{}, error) {
	...
	if !found {
		...
		if !api.backend.TxIndexDone() {
			return nil, silaapi.NewTxIndexingError()
		}
...
// TraceCall lets you trace a given sila_call. It collects the structured logs
...
func (api *API) TraceCall(ctx context.Context, args silaapi.TransactionArgs, blockNrOrHash rpc.BlockNumberOrHash, config *TraceCallConfig) (interface{}, error) {
