...
func (q *receiptQueue) request(peer *peerConnection, req *fetchRequest, resCh chan *sila.Response) (*sila.Request, error) {
...
func (q *receiptQueue) deliver(peer *peerConnection, packet *sila.Response) (int, error) {
	receipts := *packet.Res.(*sila.ReceiptsRLPResponse)
