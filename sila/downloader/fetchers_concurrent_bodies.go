...
func (q *bodyQueue) request(peer *peerConnection, req *fetchRequest, resCh chan *sila.Response) (*sila.Request, error) {
...
func (q *bodyQueue) deliver(peer *peerConnection, packet *sila.Response) (int, error) {
	resp := packet.Res.(*sila.BlockBodiesResponse)
	meta := packet.Meta.(sila.BlockBodyHashes)
