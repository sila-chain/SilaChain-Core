...
func newPathTrie(owner common.Hash, skipLeftBoundary bool, db siladb.KeyValueReader, batch siladb.Batch) *pathTrie {
	tr := &pathTrie{
		owner:            owner,
...
func newHashTrie(batch siladb.Batch) *hashTrie {
