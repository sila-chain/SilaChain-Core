...
// in the `sila` protocol without actually doing any data processing.
...
func newTestBackendWithGenerator(blocks int, shanghai bool, cancun bool, generator func(int, *core.BlockGen)) *testBackend {
	...
	_, bs, _ := core.GenerateChainWithGenesis(gspec, silaEngine, blocks, generator)
...
func TestGetBlockHeaders69(t *testing.T) { testGetBlockHeaders(t, SILA69) }
...
func TestGetBlockBodies69(t *testing.T) { testGetBlockBodies(t, SILA69) }
...
func TestGetBlockReceipts69(t *testing.T) { testGetBlockReceipts(t, SILA69) }
...
func TestGetBlockPartialReceipts(t *testing.T) { testGetBlockPartialReceipts(t, SILA70) }
...
func TestGetBlockAccessLists(t *testing.T) { testGetBlockAccessLists(t, SILA71) }
...
func setup() (*testBackend, *testPeer) {
	...
	backend := newTestBackendWithGenerator(maxBodiesServe+15, true, false, gen)
	peer, _ := newTestPeer("peer", SILA69, backend)
