...
func init() {
	meters = bidirectionalMeters{
		ingress: newHandshakeMeters("sila/protocols/sila/ingress/handshake/"),
		egress:  newHandshakeMeters("sila/protocols/sila/egress/handshake/"),
	}
}
