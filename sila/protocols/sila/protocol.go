...
// ProtocolName is the official short name of the `sila` protocol used during
// devp2p capability negotiation.
const ProtocolName = "sila"

// ProtocolVersions are the supported versions of the `sila` protocol (first
// is primary).
var ProtocolVersions = []uint{SILA71, SILA70, SILA69}

// protocolLengths are the number of implemented message corresponding to
// different protocol versions.
var protocolLengths = map[uint]uint64{SILA71: 20, SILA69: 18, SILA70: 18}
...
// Packet represents a p2p message in the `sila` protocol.
...
// NewPooledTransactionHashesPacket represents a transaction announcement packet on sila/68 and newer.
