...
// Peer is a collection of relevant information we have about a `sila` peer.
type Peer struct {
...
// Version retrieves the peer's negotiated `sila` protocol version.
func (p *Peer) Version() uint {
	return p.version
}

// BlockRange returns the latest announced block range.
// This will be nil for peers below protocol version sila/69.
