...
func newTestBackend(t *testing.T, londonBlock *big.Int, cancunBlock *big.Int, pending bool) *testBackend {
	...
	db, blocks, _ := core.GenerateChainWithGenesis(gspec, silaEngine, testHead+1, func(i int, b *core.BlockGen) {
	...
	chain, err := core.NewBlockChain(db, gspec, silaEngine, &core.BlockChainConfig{NoPrefetch: true})
	if err != nil {
