...
func newTestBlockChain(t *testing.T, n int, gspec *core.Genesis, generator func(i int, b *core.BlockGen)) *core.BlockChain {
	...
	_, blocks, _ := core.GenerateChainWithGenesis(gspec, silaEngine, n, generator)
	...
	chain, err := core.NewBlockChain(rawdb.NewMemoryDatabase(), gspec, silaEngine, options)
	if err != nil {
...
func TestDebugAPI_ClearTxpool(t *testing.T) {
	...
	chain, _ := core.NewBlockChain(db, testGspec, silaEngine, nil)
