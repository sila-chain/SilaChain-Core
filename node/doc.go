...
/*
Package node sets up multi-protocol SilaChain nodes.
...
endpoint to a subset of RPC modules. Node itself offers the "debug", "admin" and "silaWeb3"
modules.
...
Node also creates the shared store of encrypted SilaChain account keys. Services can access
