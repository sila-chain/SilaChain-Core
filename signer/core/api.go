...
type ExternalAPI interface {
	...
	SignTransaction(ctx context.Context, args apitypes.SendTxArgs, methodSelector *string) (*silaapi.SignTransactionResult, error)
...
type UIClientAPI interface {
	...
	OnApprovedTx(tx silaapi.SignTransactionResult)
...
func (api *SignerAPI) SignTransaction(ctx context.Context, args apitypes.SendTxArgs, methodSelector *string) (*silaapi.SignTransactionResult, error) {
	var (
		err    error
	...
	response := silaapi.SignTransactionResult{Raw: data, Tx: signedTx}
