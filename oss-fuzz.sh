...
coverpkg="github.com/sila-org/sila/..."
  ...
  go get github.com/holiman/gofuzz-shim/testing
	...
	if [[ $SANITIZER == *coverage* ]]; then
	  ...
	  gofuzz-shim --func $function --package $package -f $file -o $fuzzer.a
		$CXX $CXXFLAGS $LIB_FUZZING_SILAENGINE $fuzzer.a -o $OUT/$fuzzer
	fi
...
repo=$GOPATH/src/github.com/sila-org/sila
compile_fuzzer github.com/sila-org/sila/accounts/abi \
  FuzzABI fuzzAbi \
  $repo/accounts/abi/abifuzzer_test.go

compile_fuzzer github.com/sila-org/sila/common/bitutil \
...
compile_fuzzer github.com/sila-org/sila/sila/protocols/snap \
  FuzzARange fuzz_account_range \
  $repo/sila/protocols/snap/handler_fuzzing_test.go
...
compile_fuzzer github.com/sila-org/sila/tests/fuzzers/bn256 \
...
compile_fuzzer github.com/sila-org/sila/tests/fuzzers/txfetcher \
  Fuzz fuzzTxfetcher \
  $repo/tests/fuzzers/txfetcher/txfetcher_test.go

compile_fuzzer github.com/sila-org/sila/tests/fuzzers/bls12381 \
...
compile_fuzzer github.com/sila-org/sila/tests/fuzzers/secp256k1 \
  Fuzz fuzzSecp256k1\
  $repo/tests/fuzzers/secp256k1/secp_test.go

compile_fuzzer github.com/sila-org/sila/sila/protocols/sila \
  FuzzSilaProtocolHandlers fuzz_sila_protocol_handlers \
  $repo/sila/protocols/sila/handler_test.go,$repo/sila/protocols/sila/peer_test.go
