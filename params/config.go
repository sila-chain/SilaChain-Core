...
var (
	...
	SilaPublicTestnetGenesisHash  = common.HexToHash("0x0d0697c32669375bcea155ee74e71d045f93f62b2c5b060e9ece746627a26a55")
...
// SilaashConfig is the consensus silaEngine configs for proof-of-work based sealing.
type SilaashConfig struct{}

// String implements the stringer interface, returning the consensus silaEngine details.
func (c SilaashConfig) String() string {
	return "silaash"
}

// CliqueConfig is the consensus silaEngine configs for proof-of-authority based sealing.
...
func (c *ChainConfig) Description() string {
	...
	switch {
	case c.Silaash != nil:
		banner += "Consensus: Beacon (proof-of-stake), merged from Silaash (proof-of-work)\n"
	case c.Clique != nil:
