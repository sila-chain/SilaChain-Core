...
// SilaDevTestnetBootnodes are the enode URLs of the P2P bootstrap nodes running on the
// SilaDevTestnet test network.
var SilaDevTestnetBootnodes = []string{
	// Sila network bootnodes
...
// SilaStagingTestnetBootnodes are the enode URLs of the P2P bootstrap nodes running on the
// SilaStagingTestnet test network.
var SilaStagingTestnetBootnodes = []string{
	// Sila network bootnodes
	"enode://ac906289e4b7f12df423d654c5a962b6ebe5b3a74cc9e06292a85221f9a64a6f1cfdd6b714ed6dacef51578f92b34c60ee91e9ede9c7f8fadc4d347326d95e2b@146.190.13.128:30303",
	"enode://a3435a0155a3e837c02f5e7f5662a2f1fbc25b48e4dc232016e1c51b544cb5b4510ef633ea3278c0e970fa8ad8141e2d4d0f9f95456c537ff05fdf9b31c15072@178.128.136.233:30303",
}

// SilaPublicTestnetBootnodes are the enode URLs of the P2P bootstrap nodes running on the
// SilaPublicTestnet test network.
var SilaPublicTestnetBootnodes = []string{
	// Sila network bootnodes
	"enode://4e5e92199ee224a01932a377160aa432f31d0b351f84ab413a8e0a42f4f36476f8fb1cbe914af0d9aef0d51665c214cf653c651c4bbd9d5550a934f241f1682b@138.197.51.181:30303", // sila-public-testnet-bootnode-1-nyc3
	"enode://143e11fb766781d22d92a2e33f8f104cddae4411a122295ed1fdb6638de96a6ce65f5b7c964ba3763bba27961738fef7d3ecc739268f3e5e771fb4c87b6234ba@146.190.1.103:30303",  // sila-public-testnet-bootnode-1-sfo3
	"enode://8b61dc2d06c3f96fddcbebb0efb29d60d3598650275dc469c22229d3e5620369b0d3dedafd929835fe7f489618f19f456fe7c0df572bf2d914a9f4e006f783a9@170.64.250.88:30303",  // sila-public-testnet-bootnode-1-syd1
	"enode://10d62eff032205fcef19497f35ca8477bea0eadfff6d769a147e895d8b2b8f8ae6341630c645c30f5df6e67547c03494ced3d9c5764e8622a26587b083b028e8@139.59.49.206:30303",  // sila-public-testnet-bootnode-1-blr1
	"enode://9e9492e2e8836114cc75f5b929784f4f46c324ad01daf87d956f98b3b6c5fcba95524d6e5cf9861dc96a2c8a171ea7105bb554a197455058de185fa870970c7c@138.68.123.152:30303", // sila-public-testnet-bootnode-1-ams3
}
...
// genesis hash and protocol. See https://github.com/sila-org/discv4-dns-lists for more
// information.
func KnownDNSNetwork(genesis common.Hash, protocol string) string {
	...
	case SilaMainnetGenesisHash:
		net = "sila-mainnet"
	case SilaPublicTestnetGenesisHash:
		net = "sila-public-testnet"
	case SilaStagingTestnetGenesisHash:
		net = "sila-staging-testnet"
	case SilaDevTestnetGenesisHash:
		net = "sila-dev-testnet"
	default:
		return ""
	}
	return dnsPrefix + protocol + "." + net + ".siladisco.net"
}
