...
func TestCheckCompatible(t *testing.T) {
	...
	tests := []test{
		{stored: AllSilaProtocolChanges, new: AllSilaProtocolChanges, headBlock: 0, headTimestamp: 0, wantErr: nil},
		{stored: AllSilaProtocolChanges, new: AllSilaProtocolChanges, headBlock: 0, headTimestamp: uint64(time.Now().Unix()), wantErr: nil},
		{stored: AllSilaProtocolChanges, new: AllSilaProtocolChanges, headBlock: 100, wantErr: nil},
		{
