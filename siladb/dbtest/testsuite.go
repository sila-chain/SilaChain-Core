...
// implementation.
func TestDatabaseSuite(t *testing.T, New func() siladb.KeyValueStore) {
...
// implementation.
func BenchDatabaseSuite(b *testing.B, New func() siladb.KeyValueStore) {
	var (
...
func iterateKeys(it siladb.Iterator) []string {
	keys := []string{}
	for it.Next() {
