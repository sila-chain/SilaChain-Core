...
func checkStateHistory(t *testing.T, freezer siladb.AncientReader, id uint64, exist bool) {
...
func checkHistoriesInRange(t *testing.T, freezer siladb.AncientReader, from, to uint64, exist bool) {
