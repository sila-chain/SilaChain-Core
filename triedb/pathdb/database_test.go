...
func TestCorruptedJournal(t *testing.T) {
	testCorruptedJournal(t, "", func(db siladb.Database) {
	...
	testCorruptedJournal(t, directory, func(_ siladb.Database) {
...
func testCorruptedJournal(t *testing.T, journalDir string, modifyFn func(database siladb.Database)) {
	// Redefine the diff layer depth allowance for faster testing.
	maxDiffLayers = 4
	defer func() {
		maxDiffLayers = 128
