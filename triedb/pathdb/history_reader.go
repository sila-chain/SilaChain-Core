...
func newIndexReaderWithLimitTag(db siladb.KeyValueReader, state stateIdent, limit uint64, bitmapSize int) (*indexReaderWithLimitTag, error) {
...
type stateHistoryReader struct {
	disk    siladb.KeyValueReader
	freezer siladb.AncientReader
...
func newStateHistoryReader(disk siladb.KeyValueReader, freezer siladb.AncientReader) *stateHistoryReader {
...
func newTrienodeReader(disk siladb.KeyValueReader, freezer siladb.AncientReader, readConcurrency int) *trienodeReader {
...
func checkStateAvail(state stateIdent, exptyp historyType, freezer siladb.AncientReader, stateID uint64, lastID uint64, db siladb.KeyValueReader) (uint64, error) {
