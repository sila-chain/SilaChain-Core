...
type singleTrienodeHistoryReader struct {
	id         uint64
	reader     siladb.AncientReader
	keyData    []byte
	valueRange iRange
}

func newSingleTrienodeHistoryReader(id uint64, reader siladb.AncientReader, keyRange iRange, valueRange iRange) (*singleTrienodeHistoryReader, error) {
...
type trienodeHistoryReader struct {
	...
	reader siladb.AncientReader // Database reader of ancient store
}

// newTrienodeHistoryReader constructs the reader for specific trienode history.
func newTrienodeHistoryReader(id uint64, reader siladb.AncientReader) *trienodeHistoryReader {
...
func writeTrienodeHistory(writer siladb.AncientWriter, dl *diffLayer, rate uint32) error {
	start := time.Now()
...
func readTrienodeMetadata(reader siladb.AncientReader, id uint64) (*trienodeMetadata, error) {
...
func readTrienodeHistory(reader siladb.AncientReader, id uint64) (*trienodeHistory, error) {
...
func readTrienodeHistories(reader siladb.AncientReader, start uint64, count uint64) ([]history, error) {
