...
func newDiskAccountIterator(db siladb.KeyValueStore, seek common.Hash) AccountIterator {
...
func newDiskStorageIterator(db siladb.KeyValueStore, account common.Hash, seek common.Hash) StorageIterator {
	pos := common.TrimRightZeroes(seek[:])
