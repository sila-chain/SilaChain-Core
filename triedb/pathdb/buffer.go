...
func (b *buffer) revertTo(db siladb.KeyValueReader, nodes map[common.Hash]map[string]*trienode.Node, accounts map[common.Hash][]byte, storages map[common.Hash]map[common.Hash][]byte) error {
...
func (b *buffer) flush(root common.Hash, db siladb.KeyValueStore, freezers []siladb.AncientWriter, progress []byte, nodesCache, statesCache *fastcache.Cache, id uint64, postFlush func()) {
	if b.done != nil {
