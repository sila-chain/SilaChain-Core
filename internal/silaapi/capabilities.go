...
import (
	...
	corestate "github.com/sila-org/sila/core/state"
)

// HistoryRetention reports a node's configured history retention windows.
// It is consumed by the sila_capabilities RPC method to derive the response
// described in https://github.com/sila-org/execution-apis/pull/755.
...
// returned by the sila_capabilities RPC method as defined in
// https://github.com/sila-org/execution-apis/pull/755.
...
// Capabilities implements the sila_capabilities RPC method as defined in
// https://github.com/sila-org/execution-apis/pull/755. It returns a
...
// buildCapabilities computes the sila_capabilities response from the head
...
func buildCapabilities(headNum uint64, headHash common.Hash, cutoff uint64, ret HistoryRetention) *Capabilities {
	...
	// sila_getProof availability tracks state availability in hash mode and
