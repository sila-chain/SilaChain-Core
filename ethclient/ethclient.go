...
// PeerCount returns the number of p2p peers as reported by the silaNet_peerCount method.
func (ec *Client) PeerCount(ctx context.Context) (uint64, error) {
	var result hexutil.Uint64
	err := ec.c.CallContext(ctx, &result, "silaNet_peerCount")
	return uint64(result), err
}
	...
	if len(body.UncleHashes) > 0 {
		...
		for i := range reqs {
			reqs[i] = rpc.BatchElem{
				Method: ec.rpcMethod("eth_getUncleByBlockHashAndIndex"),
...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	err = ec.c.CallContext(ctx, &json, ec.rpcMethod("eth_getTransactionByHash"), hash)
	if err != nil {
...
func (ec *Client) TransactionSender(ctx context.Context, tx *types.Transaction, block common.Hash, index uint) (common.Address, error) {
	...
	if err = ec.c.CallContext(ctx, &meta, ec.rpcMethod("eth_getTransactionByBlockHashAndIndex"), block, hexutil.Uint64(index)); err != nil {
...
func (ec *Client) TransactionCount(ctx context.Context, blockHash common.Hash) (uint, error) {
	...
	err := ec.c.CallContext(ctx, &num, ec.rpcMethod("eth_getBlockTransactionCountByHash"), blockHash)
	return uint(num), err
}
...
func (ec *Client) TransactionInBlock(ctx context.Context, blockHash common.Hash, index uint) (*types.Transaction, error) {
	var json *rpcTransaction
	err := ec.c.CallContext(ctx, &json, ec.rpcMethod("eth_getTransactionByBlockHashAndIndex"), blockHash, hexutil.Uint64(index))
	if err != nil {
		return nil, err
	}
	if json == nil {
...
func (ec *Client) BalanceAt(ctx context.Context, account common.Address, blockNumber *big.Int) (*big.Int, error) {
	var result hexutil.Big
	err := ec.c.CallContext(ctx, &result, ec.rpcMethod("eth_getBalance"), account, toBlockNumArg(blockNumber))
	return (*big.Int)(&result), err
}
...
func (ec *Client) BalanceAtHash(ctx context.Context, account common.Address, blockHash common.Hash) (*big.Int, error) {
	var result hexutil.Big
	err := ec.c.CallContext(ctx, &result, ec.rpcMethod("eth_getBalance"), account, rpc.BlockNumberOrHashWithHash(blockHash, false))
	return (*big.Int)(&result), err
}
...
func (ec *Client) StorageAt(ctx context.Context, account common.Address, key common.Hash, blockNumber *big.Int) ([]byte, error) {
	...
	err := ec.c.CallContext(ctx, &result, ec.rpcMethod("eth_getStorageAt"), account, key, toBlockNumArg(blockNumber))
	return result, err
}
...
func (ec *Client) StorageAtHash(ctx context.Context, account common.Address, key common.Hash, blockHash common.Hash) ([]byte, error) {
	var result hexutil.Bytes
	err := ec.c.CallContext(ctx, &result, ec.rpcMethod("eth_getStorageAt"), account, key, rpc.BlockNumberOrHashWithHash(blockHash, false))
	return result, err
}
...
func (ec *Client) CodeAt(ctx context.Context, account common.Address, blockNumber *big.Int) ([]byte, error) {
	var result hexutil.Bytes
	err := ec.c.CallContext(ctx, &result, ec.rpcMethod("eth_getCode"), account, toBlockNumArg(blockNumber))
	return result, err
}
...
func (ec *Client) CodeAtHash(ctx context.Context, account common.Address, blockHash common.Hash) ([]byte, error) {
	var result hexutil.Bytes
	err := ec.c.CallContext(ctx, &result, ec.rpcMethod("eth_getCode"), account, rpc.BlockNumberOrHashWithHash(blockHash, false))
	return result, err
}
...
func (ec *Client) NonceAt(ctx context.Context, account common.Address, blockNumber *big.Int) (uint64, error) {
	var result hexutil.Uint64
	err := ec.c.CallContext(ctx, &result, ec.rpcMethod("eth_getTransactionCount"), account, toBlockNumArg(blockNumber))
	return uint64(result), err
}
...
func (ec *Client) NonceAtHash(ctx context.Context, account common.Address, blockHash common.Hash) (uint64, error) {
	var result hexutil.Uint64
	err := ec.c.CallContext(ctx, &result, ec.rpcMethod("eth_getTransactionCount"), account, rpc.BlockNumberOrHashWithHash(blockHash, false))
	return uint64(result), err
}
...
func (ec *Client) PendingBalanceAt(ctx context.Context, account common.Address) (*big.Int, error) {
	var result hexutil.Big
	err := ec.c.CallContext(ctx, &result, ec.rpcMethod("eth_getBalance"), account, "pending")
	return (*big.Int)(&result), err
}
...
func (ec *Client) PendingStorageAt(ctx context.Context, account common.Address, key common.Hash) ([]byte, error) {
	var result hexutil.Bytes
	err := ec.c.CallContext(ctx, &result, ec.rpcMethod("eth_getStorageAt"), account, key, "pending")
	return result, err
}
...
func (ec *Client) PendingCodeAt(ctx context.Context, account common.Address) ([]byte, error) {
	var result hexutil.Bytes
	err := ec.c.CallContext(ctx, &result, ec.rpcMethod("eth_getCode"), account, "pending")
	return result, err
}
...
func (ec *Client) PendingNonceAt(ctx context.Context, account common.Address) (uint64, error) {
	var result hexutil.Uint64
	err := ec.c.CallContext(ctx, &result, ec.rpcMethod("eth_getTransactionCount"), account, "pending")
	return uint64(result), err
}
